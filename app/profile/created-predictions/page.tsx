...
export default function CreatedPredictionsPage() {
  ...
  const createdMarkets = [
    ...
    {
      id: 5,
      title: "MON will outperform Ethereum in Q4 2024",
      category: "crypto",
      ...
      resolutionSource: "CoinGecko price data",
              description: "Will MON's price performance exceed Ethereum's in Q4 2024?",
      creatorFee: "2%"
    },
    {
      id: 6,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm text-text-muted">Total Volume</div>
                              <div className="text-xl font-bold text-white">{stats.totalVolume} MON</div>
            </div>
          </div>
        </div>
      </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-text-secondary">{market.volume} MON</span>
                    </div>
                    <div className="flex items-center gap-1">

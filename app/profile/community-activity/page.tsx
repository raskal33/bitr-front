...
export default function CommunityActivityPage() {
  ...
  const communityData = {
    followers: [
      ...
      { id: 3, username: "stt_fan", displayName: "MON Fan", avatar: "💎", followDate: "2 weeks ago", isFollowing: true },
    ...
    following: [
      ...
      { id: 9, username: "stt_trader", displayName: "MON Trader", avatar: "💰", followDate: "3 weeks ago", isFollowing: true },
    ...
    activity: [
      ...
      { 
        id: 3, 
        type: "bet", 
            user: { username: "stt_fan", displayName: "MON Fan", avatar: "💎" },
    timestamp: "5 days ago",
    content: "placed a bet on your prediction \"MON will outperform ETH in Q4\"",
    betAmount: "25 MON on Yes"
      },
      { 
        id: 4, 
        type: "like", 
